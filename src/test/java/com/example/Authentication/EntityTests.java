...
public class EntityTests {
	...
	public void getAndSetName() {
		...
		testUser.setName("kanna");
		assertEquals(testUser.getName(),"kanna");
	}
	...
	public void getAndSetEmail() {
		...
		testUser.setEmail("kanna@gmail.com");
		assertEquals(testUser.getEmail(),"kanna@gmail.com");
	}
	...
	public void checkConstructor() {
		User testUser = new User("kanna","kanna@gmail.com","123");
		
		User checkUser = new User();
		checkUser.setName("kanna");
		checkUser.setEmail("kanna@gmail.com");
